...
export const DEVICES: RackDevice[] = [
  ...
  { id: 'minisforum_ai_x1', name: 'Minisforum AI X1', category: 'mini_pc', width: 127.5, height: 58, depth: 125.5 },
  ...
  { id: 'raspberry_pi_5_waveshare_poe', name: 'Raspberry Pi 5 + Waveshare PoE NVME HAT', category: 'sbc', width: 66, height: 30, depth: 97 },
