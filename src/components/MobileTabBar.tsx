...
export function MobileTabBar({ activeTab, onTabChange, deviceCount }: MobileTabBarProps) {
          ...
          return (
            ...
            >
              ...
              <div className="relative">
                {tab.icon}
                {/* Badge for devices tab */}
                {tab.id === 'devices' && deviceCount > 0 && (
                  <span className="absolute -top-1 -right-1.5 min-w-[14px] h-[14px] bg-blue-500 text-white text-[9px] font-bold rounded-full flex items-center justify-center px-0.5">
                    {deviceCount}
                  </span>
                )}
              </div>
