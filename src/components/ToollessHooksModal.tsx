...
export function ToollessHooksModal({ onClose }: ToollessHooksModalProps) {
  ...
  return (
    <div role="dialog" aria-modal="true" aria-label="Rack settings" onKeyDown={e => { if (e.key === 'Escape') { e.stopPropagation(); onClose(); } }} className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-gray-800 rounded-lg shadow-xl w-[400px] max-w-[calc(100vw-24px)] max-h-[85dvh] overflow-y-auto">
        {/* Header */}
